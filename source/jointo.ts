...
const DEFAULT_MONSTERS: MonsterName[] = ["arcticbee","phoenix","greenjr",]
...
const WARRIORS = ["JoiNtor","JoiNtorra"]
const MAGES = [] //["JoiNty"]
const PRIESTS = ["JoiNtie"]
const RANGERS = [] // ["JoiNto"]
...
async function startShared(context: Strategist<PingCompensatedCharacter>, privateContext = false) {
    ...
    context.applyStrategy(metricsStrategy)
}
